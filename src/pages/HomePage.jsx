    ...
    <div className="flex min-h-screen w-full items-center flex-col bg-light-900 dark:bg-dark-100">
      <div className="flex w-full justify-between">
        ...
        <div className="flex gap-3">
          <p>Share</p>
          <img src="/assets/chat.png" width={15} alt="" />
          <img src="/assets/star-filled.svg" width={15} alt="" />
          <img src="/assets/menu.png" width={15} alt="" />
        </div>
      </div>
      <div className="w-[700px]">
        ...
        <img src="/assets/homeimg.png" alt="homeimg" width="700px" />
